...
from projects import models as proj
...
class UserApplicationStatus(LoginRequiredMixin, generic.TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        position = proj.Position.objects.filter(pk=position_id).first()
